...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BootyCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"bootycointools.com", "dnsseed.bootycointools.com"},
    {"bootycoinpool.org", "dnsseed.bootycoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"bootycointools.com", "testnet-seed.bootycointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BootyCoin is probably already running."), addrBind.ToString().c_str());
        else
